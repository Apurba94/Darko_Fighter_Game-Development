...
void selectMenuOption(int menu_x, int menu_y)
{
	...
	{
		if (menu_x >= 483 && menu_x <= 885 && menu_y >= 551 && menu_y <= 601)
		{
			menu_option = 1; //For start menu.
		}

		if (menu_x >= 483 && menu_x <= 885 && menu_y >= 475 && menu_y <= 526)
		{
			menu_option = 2; //For high scores.
		}

		if (menu_x >= 483 && menu_x <= 885 && menu_y >= 398 && menu_y <= 450)
		{
			menu_option = 3; //For instructions.
		}

		if (menu_x >= 483 && menu_x <= 885 && menu_y >= 325 && menu_y <= 373)
		{
			menu_option = 4; //For options.
		}

		if (menu_x >= 483 && menu_x <= 885 && menu_y >= 249 && menu_y <= 301)
		{
			menu_option = 5; //For about.
		}

		if (menu_x >= 483 && menu_x <= 885 && menu_y >= 172 && menu_y <= 220)
		{
			exit(0); //For exit.
		}
	}
	...
	{
		if (menu_x >= 483 && menu_x <= 885 && menu_y >= 170 && menu_y <= 220)
		{
