...
void iPassiveMouse(int mx, int my)
{
	if (!pause)
	{
		...
		if (menu_option >= 0 && menu_option <= 5)
		{
			if (mx >= 483 && mx <= 885 && my >= 551 && my <= 601)
			{
				highlight_index = 0;
			}
			else if (mx >= 483 && mx <= 885 && my >= 475 && my <= 526)
			{
				highlight_index = 1;
			}
			else if (mx >= 483 && mx <= 885 && my >= 398 && my <= 450)
			{
				highlight_index = 2;
			}
			else if (mx >= 483 && mx <= 885 && my >= 325 && my <= 373)
			{
				highlight_index = 3;
			}
			else if (mx >= 483 && mx <= 885 && my >= 249 && my <= 301)
			{
				highlight_index = 4;
			}
			else if (mx >= 483 && mx <= 885 && my >= 172 && my <= 220)
			{
				highlight_index = 5;
			}
			else
			...
			if (mx >= 483 && mx <= 885 && my >= 170 && my <= 220)
			{
		...
		{
			if (mx >= 496 && mx <= 868 && my >= 143 && my <= 194)
			{
...
void iKeyboard(unsigned char key)
{
	if (!pause)
	{
		if (field_active) //If high score is achieved and textbox is active for entering name.
		{
			inputName(key);
		}
